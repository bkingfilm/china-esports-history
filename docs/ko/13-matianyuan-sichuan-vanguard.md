...
여기서 짚어 두자면, 이 글을 쓰는 시점의 AG.QQ회원.스쿵잔셴 클럽이 바로 그때의 =A.G= 아시아게임 팀에서 이어진 것이다. 다만 지금 AG의 정식 명칭은 AllGamer로 바뀌었다. 그 과정은 뒤에서 다시 이야기한다.
...
2000년 제1회 대회가 아직 WCGC라고 불리던 때, 마톈위안도 여기에 나갔다. 이름이 WCG로 바뀐 것은 2001년부터다. 그는 금세 탈락했고, 그 일이 그를 더 지독한 훈련으로 밀어 넣었다. 자는 시간을 빼고 하루 열일고여덟 시간을 아시아게임 배틀넷에서 스타크래프트만 했다.
...
스타크래프트 2대2 결승 상대는 독일이었고, 그 팀에는 중국에서 위옌징(鱼眼睛), 곧 '물고기 눈'으로 불리던 유명 선수가 있었다. 경기는 치열해서 2대 2까지 갔고 현장에서는 관중 천여 명이 소리를 질렀다. 우승이 확정된 순간 장내는 우레와 같은 박수로 뒤덮였지만 마톈위안의 머릿속은 하얘졌다. 그는 아무것도 기억나지 않는다고 했다. 시상대에 올라 손에 오성홍기를 쥐고 나서야 정신이 돌아왔다.
...
이렇게 해서 AG.쉰유.스쿵잔셴이 부활했다. 이 글을 쓰는 시점의 이름은 AG.QQ회원.스쿵잔셴이다.
...
그 모습을 보고 있으니 마음이 여러 갈래로 움직였고, 귀에는 그 유명한 내레이션이 울렸다. 평생 전장을 누비며 수많은 적을 벤 자유로운 방랑자가, 이번 생에서 마침내 자기에게 점 세 개를 남긴 사람을 만났다. 그때부터 그는 스스로 금고를 머리에 쓰고 오만하고 길들지 않던 성정을 거뒀다. 그리고 무게 1만 3,500근에 길이는 한 장 두 자, 굵기는 사발 아가리만 하고, 크게도 작게도 길게도 짧게도 바뀌는 여의금고봉을 들고 새로운 여정에 올랐다.
